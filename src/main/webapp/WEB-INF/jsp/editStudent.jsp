...
<body>
    <div style="width: 500px; margin:0 auto; text-align: center;">
        <div style="text-align: center; margin-top: 40px;">
            ...
            预计入学时间：  <input type="text" name="study_time" value="${stu.study_time}"><br><br>
            ...
            创建时间：     <input type="text" name="create_at" value="${stu.create_at}"><br><br>
            最后更新时间：  <input type="text" name="update_at" value="${stu.update_at}"><br><br>
